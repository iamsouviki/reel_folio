...
import 'package:reel_folio/screens/CreateProject(Completed)/widget/project_upload_textfield_widget.dart';
import 'package:reel_folio/screens/CreateProject(Completed)/select_category.dart';
              ...
              children: [
                Container(
                  ...
                  padding: EdgeInsets.symmetric(
                      horizontal: screenWidth! * 40/ 375, vertical: screenHeight! * 0.06),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20.0),
                  child: ProjectUploadDetails("1-2 sentence description of your project."),
                ),
                const SizedBox(
                  height: 30,
                ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20.0),
                  child: ProjectUploadDetails("What else do you want people to know? (i.e., total run time, awards, year, inspiration for the film, location, etc.)"),
                ),
                const SizedBox(
                  height: 30,
                ),
