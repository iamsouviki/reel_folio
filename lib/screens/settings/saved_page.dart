...
import 'package:reel_folio/screens/settings/widgets/saved_list_widget.dart';
import 'package:reel_folio/screens/settings/widgets/saved_navbar_widget.dart';
    ...
    return SafeArea(
      ...
      child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Container(
                height: screenHeight, child: _verticalList(3, context)),
          )),
    );
  }
}
