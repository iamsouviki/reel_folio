...
Widget HomeNavbar(BuildContext context, TabController tabController) {
  return AppBar(
    ...
    flexibleSpace: NavbarUtil(context, tabController),
    elevation: 0,
  );
}

Widget NavbarUtil(BuildContext context, TabController tabController) {
  return Column(
    children: [
          ...
          children: [
            ...
            Container(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(
                    fixedSize: MaterialStateProperty.all(const Size(120, 20)),
                    backgroundColor:
