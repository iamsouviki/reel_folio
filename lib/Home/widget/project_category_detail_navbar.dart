...
Widget ProjectCategoryNavbar(BuildContext context, String category) {
  return AppBar(
    ...
    flexibleSpace: NavbarUtilProject(context, category),
    elevation: 0,
  );
}

Widget NavbarUtilProject(BuildContext context, String category) {
  return Column(
    children: [
