...
import '../../authentication-flow/manager/authentication_manager.dart';
import '../../screens/Portfolio/widget/popup.dart';
import '../../util/asset.dart';
import '../../util/colors.dart';
import '../../util/reel_folio_icon.dart';
import '../../util/size_config.dart';

class PeoplePortfolioScreen extends StatefulWidget {

  final int id;

  const PeoplePortfolioScreen({Key? key, required this.id}) : super(key: key);

  @override
  State<PeoplePortfolioScreen> createState() => _PeoplePortfolioScreenState();
}

class _PeoplePortfolioScreenState extends State<PeoplePortfolioScreen> {
  @override
      ...
      child: Scaffold(
        ...
        body: Consumer(
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            var userResponse = ref.watch(peoplePortfolioManager(widget.id.toString()));
